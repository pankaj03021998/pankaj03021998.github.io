...
<html>
  <head>
    ...
    <body>
        ...
        <div class="container">
             <div class="jumbotron">
                 <center><h3><b><span class="glyphicon glyphicon-thumbs-up"></span> Order successfully Placed</b></h1>
                    <p>Thank you for shopping
                        with us.</p></center>
            </div>
            <center><a href="products.html">click here</a> to purchase any other item.
            </center>
        </div>
        <br>
        <br>
